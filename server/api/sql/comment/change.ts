...
export default defineEventHandler(async (event) => {
    ...
    await db.sql`UPDATE comments
         SET
             message = ${requestBody.comment.message},
             likes = ${requestBody.comment.likes},
             dislikes = ${requestBody.comment.dislikes}
         WHERE
             user_id = ${requestBody.comment.user_id}
