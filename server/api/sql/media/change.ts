...
export default defineEventHandler(async (event) => {
    ...
    await db.sql`UPDATE medias
         SET
             project_id = ${requestBody.media.project_id},
             news_id = ${requestBody.media.news_id},
             numero = ${requestBody.media.numero},
             src_ddl = ${requestBody.media.src_ddl},
             nb_ddl = ${requestBody.media.nb_ddl},
             src_streaming = ${requestBody.media.src_streaming},
             viewed = ${requestBody.media.viewed},
             sums = ${requestBody.media.sums},
             likes = ${requestBody.media.likes},
             dislikes = ${requestBody.media.dislikes},
             _active = ${requestBody.media._active},
             name = ${requestBody.media.name}
         WHERE
             _id = ${requestBody.media._id}
